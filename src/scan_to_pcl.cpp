...
void ydlidar_callbacks(const sensor_msgs::LaserScan::ConstPtr& scan_in)
{
...
int main(int argc, char **argv) {
    ...
    ydlidar_sub = nh.subscribe<sensor_msgs::LaserScan>("/ydlidar_filtered", 1, ydlidar_callbacks);
